/* Variables for changing the text in Ptag for inputs */
const carVar = "Car"
...
/* These Functions correspond to each inputs 'onclick' in the html and change the inner text in the Ptag */
...
function submit() {
    ...
    if (score < 10) {
        resultsBar.style.width = "10%";
        document.getElementById("resultsBarResponseText").innerText = "Woah dude, you are a horribly unsustainable climber. Shame on you";
        document.getElementById("resultsBarResponseText").style.display = "block";
    }
    else if (score < 17) {
        resultsBar.style.width = "25%";
        document.getElementById("resultsBarResponseText").innerText = "Not terrible but not great either, you can do better";
        document.getElementById("resultsBarResponseText").style.display = "block";
    }
    else if (score < 22) {
        resultsBar.style.width = "35%";
        document.getElementById("resultsBarResponseText").innerText = "Nice, you are a pretty sustainable climber.";
        document.getElementById("resultsBarResponseText").style.display = "block";
    }
    else if (score == 28) {
        resultsBar.style.width = "60%";
        document.getElementById("resultsBarResponseText").innerText = "You are the epitomy of sustainability you absolute legend.";
        document.getElementById("resultsBarResponseText").style.display = "block";
    }
    else if (score > 21) {
        resultsBar.style.width = "50%";
        document.getElementById("resultsBarResponseText").innerText = "You are an extremely sustainable climber! Almost a full score";
        document.getElementById("resultsBarResponseText").style.display = "block";
    }
    else{};
}
